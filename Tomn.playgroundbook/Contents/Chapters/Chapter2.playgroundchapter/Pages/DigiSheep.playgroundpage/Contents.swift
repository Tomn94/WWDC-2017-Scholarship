...
/// Speed up animations
let animationsSpeed = /*#-editable-code Speed up animations*/1.0/*#-end-editable-code*/

/// Adjust Phone spring effect
let phoneDamping: CGFloat = /*#-editable-code Adjust Phone spring effect*/0.6/*#-end-editable-code*/

/// Change Phone arriving speed
let phoneVelocity: CGFloat = /*#-editable-code Change Phone arriving speed*/6/*#-end-editable-code*/
